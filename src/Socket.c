...
#endif
{
	...
	struct addrinfo hints = {0, AF_UNSPEC, SOCK_STREAM, IPPROTO_TCP, 0, NULL, NULL, NULL}; // Formerly contained AI_ADDRCONFIG but our version of netdb.h doesn't have it
